...
export default class AddTermButton extends React.Component {
    state = {
        open: false,
        deadLine: null,
        deadLineSent: null,
    ...
    handleSubmit = () => {
        api.addTerm(this.state.deadLineSent);
    ...
    render(){
        ...
        return (
            <div>
                <RaisedButton label="Add Term" onClick={this.handleOpen} />
                <Dialog
